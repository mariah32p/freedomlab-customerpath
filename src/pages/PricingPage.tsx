    ...
    <div className="min-h-screen bg-white font-montserrat">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          {/* FAQ Section */}
          <div className="mt-20">
            <h3 className="text-3xl font-bold text-brand-navy text-center mb-12">Frequently Asked Questions</h3>
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-gray-50 p-6 rounded-xl">
                <h4 className="font-bold text-brand-navy mb-3">How does the free trial work?</h4>
                <p className="text-gray-600">Start with full access to all Pro features for 7 days. Add your payment method to continue after the trial.</p>
              </div>
              <div className="bg-gray-50 p-6 rounded-xl">
                <h4 className="font-bold text-brand-navy mb-3">Can I change plans anytime?</h4>
                <p className="text-gray-600">Yes! Upgrade or downgrade your plan at any time. Changes take effect immediately with prorated billing.</p>
              </div>
              <div className="bg-gray-50 p-6 rounded-xl">
                <h4 className="font-bold text-brand-navy mb-3">What integrations do you support?</h4>
                <p className="text-gray-600">Connect with Google Analytics, Mixpanel, Segment, and 50+ other tools via API. CSV import is also available.</p>
              </div>
              <div className="bg-gray-50 p-6 rounded-xl">
                <h4 className="font-bold text-brand-navy mb-3">Is my data secure?</h4>
                <p className="text-gray-600">Absolutely. We use enterprise-grade encryption and are SOC 2 compliant. Your data never leaves our secure servers.</p>
              </div>
            </div>
          </div>
        </div>
