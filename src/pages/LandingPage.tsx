...
const LandingPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-white font-montserrat">
      ...
      {/* Hero Section */}
      <section className="pt-24 md:pt-32 pb-16 md:pb-20 bg-gradient-to-br from-brand-navy via-brand-navy/95 to-brand-purple/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            {/* Left Column - Content */}
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center bg-brand-teal/20 text-brand-teal px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-semibold mb-6 sm:mb-8 border border-brand-teal/30">
              ...
              <p className="text-base sm:text-lg md:text-xl text-white/80 mb-6 sm:mb-8 md:mb-10 leading-relaxed max-w-xl mx-auto lg:mx-0 px-2 sm:px-0">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-2 sm:space-y-0 sm:space-x-6 md:space-x-8 text-xs sm:text-sm text-white/70">
            ...
            <div className="relative">
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 border border-white/20 shadow-2xl mx-4 sm:mx-0">
                <div className="flex items-center justify-between mb-4 sm:mb-6 md:mb-8">
                  <h3 className="text-lg sm:text-xl font-bold text-white">E-commerce Funnel</h3>
                ...
                <div className="space-y-3 sm:space-y-4 md:space-y-6">
                  {/* Stage 1: Discovery */}
                  <div className="flex items-center justify-between bg-white/20 backdrop-blur-sm p-3 sm:p-4 md:p-5 rounded-lg sm:rounded-xl border border-white/30">
                    <div className="flex items-center">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gradient-to-br from-blue-400 to-blue-600 rounded-lg sm:rounded-xl flex items-center justify-center mr-3 sm:mr-4 shadow-lg">
                        <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                        </svg>
                      </div>
                      <div>
                        <span className="font-bold text-white text-sm sm:text-base">Discovery</span>
                        <p className="text-brand-teal text-xs sm:text-sm font-semibold">8,247 visitors</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-lg sm:text-xl font-bold text-white">78%</div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between bg-white/20 backdrop-blur-sm p-3 sm:p-4 md:p-5 rounded-lg sm:rounded-xl border border-white/30">
                    <div className="flex items-center">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gradient-to-br from-brand-teal to-cyan-500 rounded-lg sm:rounded-xl flex items-center justify-center mr-3 sm:mr-4 shadow-lg">
                        <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                        </svg>
                      </div>
                      <div>
                        <span className="font-bold text-white text-sm sm:text-base">Trial</span>
                        <p className="text-brand-teal text-xs sm:text-sm font-semibold">3,421 signups</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-lg sm:text-xl font-bold text-white">41%</div>
                    </div>
                  </div>
                  
                  {/* Stage 3: Conversion */}
                  <div className="flex items-center justify-between bg-white/30 backdrop-blur-sm p-3 sm:p-4 md:p-5 rounded-lg sm:rounded-xl border border-white/40 shadow-lg">
                    <div className="flex items-center">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg sm:rounded-xl flex items-center justify-center mr-3 sm:mr-4 shadow-lg">
                        <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                      </div>
                      <div>
                        <span className="font-bold text-white text-sm sm:text-base">Customers</span>
                        <p className="text-brand-teal text-xs sm:text-sm font-semibold">2,289 paid</p>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-lg sm:text-xl font-bold text-green-400">$114k</div>
                    </div>
                  </div>
                </div>
                
                {/* Bottom Metric */}
                <div className="mt-4 sm:mt-6 md:mt-8 pt-4 sm:pt-6 border-t border-white/20 text-center">
                  <div className="text-xl sm:text-2xl font-bold text-white">27.8%</div>
                  <div className="text-white/70 text-xs sm:text-sm">Overall Conversion Rate</div>
                </div>
              </div>
              
              {/* Floating Elements */}
              <div className="absolute -top-4 -right-2 sm:-top-6 sm:-right-6 bg-brand-teal text-white px-3 sm:px-6 py-2 sm:py-3 rounded-lg sm:rounded-xl shadow-xl text-xs sm:text-sm font-bold animate-bounce">
                🔥 Live Data
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-brand-navy mb-4 px-4">
            ...
            <div className="mt-6 sm:mt-8 mb-6 sm:mb-8 max-w-3xl mx-auto px-4">
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl p-4 sm:p-6 shadow-xl border-2 border-white/20">
                <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-3 mb-2">
                  ...
                  <span className="font-bold text-base sm:text-lg text-center sm:text-left">🎬 Interactive Demo</span>
                </div>
                <p className="text-white/90 text-center font-medium text-sm sm:text-base">
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-brand-navy mb-4 sm:mb-6 px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto">
            {/* Standard Plan */}
            <div className="bg-white p-6 sm:p-8 lg:p-10 rounded-2xl sm:rounded-3xl shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300 mx-4 lg:mx-0">
              <div className="text-center mb-8 sm:mb-10">
                <h3 className="text-2xl sm:text-3xl font-bold text-brand-navy mb-3 sm:mb-4">Standard</h3>
                <div className="text-4xl sm:text-5xl lg:text-6xl font-bold text-brand-navy mb-3 sm:mb-4">
                  $29<span className="text-lg sm:text-xl lg:text-2xl font-normal text-gray-500">/month</span>
                </div>
                <p className="text-base sm:text-lg text-gray-600">Perfect for small teams and startups</p>
              </div>
              ...
              <div className="space-y-4 sm:space-y-5 mb-8 sm:mb-10">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700 text-sm sm:text-base lg:text-lg">Up to 5 customer journey maps</span>
                </div>
                <div className="flex items-center">
                  <svg className="h-6 w-6 text-brand-teal mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700 text-sm sm:text-base lg:text-lg">Up to 10,000 events per month</span>
                </div>
                <div className="flex items-center">
                  <svg className="h-6 w-6 text-brand-teal mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700 text-sm sm:text-base lg:text-lg">Real-time analytics & live feed</span>
                </div>
                <div className="flex items-center">
                  <svg className="h-6 w-6 text-brand-teal mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700 text-sm sm:text-base lg:text-lg">Basic webhook setup</span>
                </div>
                <div className="flex items-center">
                  <svg className="h-6 w-6 text-brand-teal mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
            ...
            {/* Pro Plan */}
            <div className="relative bg-white p-6 sm:p-8 lg:p-10 rounded-2xl sm:rounded-3xl shadow-2xl border-2 border-brand-teal mx-4 lg:mx-0">
              <div className="absolute -top-4 sm:-top-5 left-1/2 transform -translate-x-1/2">
                <span className="bg-brand-teal text-white px-4 sm:px-6 lg:px-8 py-2 sm:py-3 rounded-full text-xs sm:text-sm font-bold shadow-xl">
                  Most Popular
                </span>
              </div>
              
              <div className="text-center mb-8 sm:mb-10">
                <h3 className="text-2xl sm:text-3xl font-bold text-brand-navy mb-3 sm:mb-4">Pro</h3>
                <div className="text-4xl sm:text-5xl lg:text-6xl font-bold text-brand-navy mb-3 sm:mb-4">
                  $49<span className="text-lg sm:text-xl lg:text-2xl font-normal text-gray-500">/month</span>
                </div>
                <p className="text-base sm:text-lg text-gray-600">For scaling businesses and agencies</p>
              </div>
              ...
              <div className="space-y-4 sm:space-y-5 mb-8 sm:mb-10">
                <div className="flex items-center">
                  ...
                  <span className="text-gray-700 text-sm sm:text-base lg:text-lg">Unlimited journey maps</span>
                </div>
                <div className="flex items-center">
                  <svg className="h-6 w-6 text-brand-teal mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700 text-sm sm:text-base lg:text-lg">Unlimited events tracking</span>
                </div>
                <div className="flex items-center">
                  <svg className="h-6 w-6 text-brand-teal mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700 text-sm sm:text-base lg:text-lg">Advanced analytics dashboard</span>
                </div>
                <div className="flex items-center">
                  <svg className="h-6 w-6 text-brand-teal mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
                  </svg>
                  <span className="text-gray-700 text-sm sm:text-base lg:text-lg">Custom webhook automation</span>
                </div>
                <div className="flex items-center">
                  <svg className="h-6 w-6 text-brand-teal mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="bg-white rounded-xl p-6 sm:p-8 shadow-sm border border-gray-100 mx-4 sm:mx-0">
              <h3 className="text-lg sm:text-xl font-bold text-brand-navy mb-3 sm:mb-4">
